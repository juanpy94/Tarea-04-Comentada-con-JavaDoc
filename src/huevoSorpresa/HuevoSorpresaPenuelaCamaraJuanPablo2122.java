...
/**
 * Clase HuevoSorpresaPenuelaCamaraJuanPablo2122 para la creación de un huevo sorpresa
 * 
...
suficientes unidades en la tienda*/
    ...
    /**
     *
     * @param unidades son las unidades de huevos sorpresa que quedan
     * @param dinero es la cantidad de dinero del que se dispone
     * @param sorpresaPenuelaCamaraJuanPablo2122 nombre de la sorpresa que
     * incluye el huevo sorpresa
     * @throws Exception si al sacar huevos sorpresa no se dispone de dinero
     * suficiente o no hay suficientes unidades en la tienda
     */
    ...
    /**
     *
     * @param aumento es el parámetro que se sumara al valor del huevo sorpresa
     * 
     * @throws Exception si la cantidad sumada de aumento y del huevo sorpresa
     * supera el precio máximo de venta
     */
